package com.fleetmanagement.document.interceptor
...
val AUTHENTICATED_USER_KEY: Context.Key<AuthenticatedUser> = Context.key("authenticatedUser")
...
class AuthServerInterceptor(
    ...
    override fun <ReqT, RespT> interceptCall(
        ...
        if (skipMethods.any { methodName.contains(it) }) return next.startCall(call, headers)
        ...
        return try {
            ...
            Contexts.interceptCall(Context.current().withValue(AUTHENTICATED_USER_KEY, user), call, headers, next)
