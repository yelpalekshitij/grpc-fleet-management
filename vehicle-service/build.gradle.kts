...
dependencies {
    ...
    implementation("org.springframework.boot:spring-boot-starter-web")  // REST health endpoint

    // gRPC server integration for Spring Boot
    ...
    // JWT for authentication interceptor
